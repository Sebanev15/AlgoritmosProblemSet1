...
public class PrestamoManager {
    InputStream inputStream = Ejercicio7.class.getClassLoader().getResourceAsStream("prestamos.txt"); //El archivo .txt debe estar en resources
    BufferedReader br = new BufferedReader(new InputStreamReader(inputStream));
    BibliotecaUCU biblioteca;
